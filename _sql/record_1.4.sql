...
-- Listage des données de la table record.artist : ~12 rows (environ)
DELETE FROM `artist`;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `usr_pwd` varchar(100) NOT NULL DEFAULT '',
  `usr_mail` varchar(50) DEFAULT NULL,
  `auth_level` tinyint(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Listage des données de la table record.user : ~5 rows (environ)
DELETE FROM `user`;
INSERT INTO `user` (`id_user`, `usr_log`, `usr_pwd`, `usr_mail`, `auth_level`) VALUES
	(9, 'utilisateur', '$2y$10$gXx2/nJI7ppq0TJEI7xNiuK9AZXogllA32Y6DF3SQX.KJVY9eLtOu', 'matthias.sergeant@gmail.com', 0),
	(10, 'superadmin', '$2y$10$fY3Se1QUNbhmDJwcgzZ8I.jl7nXzmJLHRtWNtIbxdhAiOvWkIE0NO', 'matthias.sergeant@gmail.com', 2),
	(11, 'administrateur', '$2y$10$tCqQzTdq4FRaB8B2v/E99uVa9NuSyjDLl4Sze9s4W0xoghTHYt0xW', 'matthias.sergeant@gmail.com', 1),
	(23, 'chris', '$2y$10$7RAjX0hP1dxQePAJLQVA.e7nHeSbFsRLH3fig466peeF5tXhZqIsm', 'chris.r@racoon.com', 0),
	(26, 'Matthias', '$2y$10$rLhY92lfptydl/ZVwraOZORnSzirS.wbzzZpyMm0UEN5pt8/Lj4L6', 'matthias.sergeant@gmail.com', 2);
